...
Generated: 2026-08-24T20:55:18.895Z
...
### SNB gaps
- **End-to-end specialist model execution** — PARTIAL; dependency: Canonical Puter specialist outputs now have persistent client-reported handoffs, independent-model reviews, HMAC receipts and multi-round consensus integration receipts; automatic Puter invocation remains; activation: 2–6 real specialist outputs → critique → correction → verified integrated artifact
...
### UES gaps
- **Semantic text/image-to-3D** — PARTIAL; dependency: Open-class compiler, SDF CSG, loft/sweep and box UV now execute; learned image-to-3D and specialist-derived arbitrary scans remain; activation: Learned or specialist-derived arbitrary geometry benchmarks
...
- **Advanced physics runtime** — PARTIAL; dependency: Swept-AABB CCD, GJK/EPA, analytic sphere/capsule CCD, yaw vertex-arc CCD and Featherstone CRBA+RNEA planar serial now execute; complete OBB-OBB rotational CCD and spatial branched ABA remain; activation: Deterministic simulation tests
- **Advanced NPC society runtime** — PARTIAL; dependency: NMN plus hierarchical 1024 compact / 64 full lives, climate/needs coupling, hour schedules, D-O15 LOD and voxel/planet/arbitrary-mesh navmesh now execute; millions of unique full agents and Recast/Detour remain; activation: Artificial-player/runtime benchmarks at population scale
