...
- **Advanced semantic world generation** — PARTIAL; dependency: Semantic world plus Voronoi city districts now execute; GIS import and runtime LOD streaming remain; activation: Larger district graphs and streaming stress tests
- **Advanced physics runtime** — PARTIAL; dependency: Swept-AABB CCD, GJK/EPA contacts, sleeping islands and conservative sampled rotational sweep now execute; analytic rotational CCD and production constraint solvers remain; activation: Deterministic simulation tests
