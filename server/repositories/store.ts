...
export interface KnowledgeMemoryVersion{id:string;userId:string;memoryId:string;projectId?:string;version:number;content:string;contentHash:string;state:'active'|'superseded'|'invalidated'|'expired';reason:string;previousId?:string;validFrom:string;validUntil?:string;createdAt:string}
...
export interface Store {
  ...
  updateMemoryContent(memoryId:string,userId:string,content:string):Memory
  deleteMemory(memoryId: string, userId: string): void
  createKnowledgeMemoryVersion(version:KnowledgeMemoryVersion):KnowledgeMemoryVersion
  getKnowledgeMemoryVersion(versionId:string,userId:string):KnowledgeMemoryVersion
  listKnowledgeMemoryVersions(userId:string,memoryId?:string,projectId?:string):KnowledgeMemoryVersion[]
  updateKnowledgeMemoryVersion(version:KnowledgeMemoryVersion):void
  replaceKnowledgeMemoryVersion(previous:KnowledgeMemoryVersion,next:KnowledgeMemoryVersion):void
  expireKnowledgeMemoryVersions(timestamp:string):number
