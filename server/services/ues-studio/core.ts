...
export class UesStudioCore {
  ...
  process() {
    ...
    const kernel = runKernel('Editor de produção remoto: grafo, inspector, timeline, undo', 'ues.studio', ['scene-graph', 'timeline'], [
      ...
      { module: 'refine', accepted: sampled['hero.tx'] === 2, note: 'timeline lerp' },
    ])
