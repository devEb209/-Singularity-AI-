...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'world.rrw', axis: 'world', name: 'RRW — representação da realidade', state: 'PARTIAL', weight: 8, note: '30 camadas + transversais executam como tecido; não é Gênesis fechada, NIST nem Unreal.' },
  { id: 'world.rrw-layers', axis: 'world', name: 'Tecido de 30 camadas da realidade', state: 'OPERATIONAL', weight: 6, note: 'Camadas 0–29 existem e se acoplam; profundidade ainda varia; D-O15 não apaga' },
  { id: 'world.rrw-transversal', axis: 'world', name: 'Sistemas transversais UES/RRW', state: 'OPERATIONAL', weight: 5, note: '20 sistemas (entidade, causa, tempo, persistência, replay); não é visualização AAA' },
  { id: 'world.rrw-construct', axis: 'world', name: 'Construção progressiva 0→29', state: 'OPERATIONAL', weight: 5, note: 'Caminho executa no grafo; não é simulação atômica sempre-ligada' },
  { id: 'world.rrw-observe', axis: 'world', name: 'Observação e replay de camadas', state: 'OPERATIONAL', weight: 4, note: 'Inspeciona qualquer camada; pausa/acelera/volta; sem framebuffer fundação' },
