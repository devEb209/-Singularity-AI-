...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'world.rrw', axis: 'world', name: 'RRW — representação da realidade', state: 'PARTIAL', weight: 8, note: 'Laço + mundo persistido/dias/sociedade/walk executam; não é Gênesis fechada, NIST nem Unreal.' },
