...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'world.rrw', axis: 'world', name: 'RRW — representação da realidade', state: 'PARTIAL', weight: 8, note: 'Matéria/espectro/D-O15/materialização executam; não é simulação atômica nem Unreal. Fundação, não preset Ultra.' },
