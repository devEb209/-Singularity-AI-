...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'create.arbitrary-3d', axis: 'creation', name: 'Geometria 3D arbitrária a partir do pedido', state: 'PARTIAL', weight: 8, note: 'CSG/loft + heightfield image-to-mesh; visão aprendida adapter' },
  ...
  { id: 'world.society', axis: 'world', name: 'Sociedade NMN', state: 'PARTIAL', weight: 4, note: '320 unique near + 1e6 estatístico compacto; não milhões de mentes' },
  ...
  { id: 'ship.gpu', axis: 'shipping', name: 'Renderer GPU / shaders / SPH', state: 'PARTIAL', weight: 6, note: 'API GPU + compute CPU + shader IR; WebGPU/Vulkan/SPH adapter' },
