...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'create.editor', axis: 'creation', name: 'Editor de produção completo', state: 'PARTIAL', weight: 8, note: 'Grafo/inspector/timeline/undo no servidor; não é viewport AAA' },
  { id: 'create.arbitrary-3d', axis: 'creation', name: 'Geometria 3D arbitrária a partir do pedido', state: 'PARTIAL', weight: 8, note: 'Classe aberta + CSG/loft/sweep; image-to-3D/especialista permanece' },
  ...
  { id: 'world.society', axis: 'world', name: 'Sociedade NMN', state: 'PARTIAL', weight: 4, note: '1024 hierárquicos / 64 full + clima; não milhões' },
