...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'world.rrw', axis: 'world', name: 'RRW — representação da realidade', state: 'PARTIAL', weight: 8, note: 'Cadeia de 10 passos + estação/hidrologia/sessão/dispositivos executam; não é Gênesis fechada, NIST nem Unreal.' },
