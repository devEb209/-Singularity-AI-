...
export const generationLedger: GenerationItem[] = [
  ...
  { id: 'intel.puter-auto', axis: 'intelligence', name: 'Invocação automática de especialistas Puter', state: 'PARTIAL', weight: 6, note: 'Infra client-side; servidor não dispara os 879' },
  { id: 'intel.consensus', axis: 'intelligence', name: 'Consenso multi-round e recibo de integração', state: 'PARTIAL', weight: 6, note: 'Correção existe; consenso automático não' },
  ...
  { id: 'create.pipeline', axis: 'creation', name: 'Pipeline 3D/PBR/cena/WebGL próprio', state: 'OPERATIONAL', weight: 6, note: 'CPU/WebGL leve, não Unreal' },
  { id: 'create.corpus', axis: 'creation', name: 'Corpus semântico + críticos', state: 'PARTIAL', weight: 6, note: '9 kinds; geometria arbitrária de especialista permanece' },
  { id: 'create.motion', axis: 'creation', name: 'Animação estruturada + Explorer', state: 'PARTIAL', weight: 5, note: 'Cards reais; visão/vídeo adapter' },
  { id: 'create.material', axis: 'creation', name: 'TITKO PBR por pedido', state: 'OPERATIONAL', weight: 5, note: 'Grafo, não bitmap 16K' },
  { id: 'create.editor', axis: 'creation', name: 'Editor de produção completo', state: 'PARTIAL', weight: 8, note: 'Studio remoto existe; não é editor AAA' },
  { id: 'create.arbitrary-3d', axis: 'creation', name: 'Geometria 3D arbitrária a partir do pedido', state: 'PARTIAL', weight: 8, note: 'Corpus 9 kinds; especialista Puter 3D permanece' },
  ...
  { id: 'world.physics', axis: 'world', name: 'Física determinística CPU', state: 'PARTIAL', weight: 6, note: 'GJK/CCD/constraints; não Featherstone' },
  { id: 'world.society', axis: 'world', name: 'Sociedade NMN', state: 'PARTIAL', weight: 4, note: 'Amostra 96, não milhões' },
  ...
  { id: 'ship.gpu', axis: 'shipping', name: 'Renderer GPU / shaders / SPH', state: 'ADAPTER', weight: 6, note: 'Sem GPU no sandbox; não fingir' },
