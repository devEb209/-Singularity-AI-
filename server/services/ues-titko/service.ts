...
export class UesTitkoService {
  private core = new UesTitkoCore()
  ...
  async compile(userId: string, input: { projectId: string; name: string }) {
    ...
    const artifact = this.artifacts.register(userId, {
      projectId: input.projectId, fileId: file.id, type: 'material.ues-titko', producer: 'ues.titko',
      verification: payload.verification,
      metadata: { virtualK: payload.material.virtualK, storedBitmap16k: false },
      license: 'Apache-2.0',
    })
