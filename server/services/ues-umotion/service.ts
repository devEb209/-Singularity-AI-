...
export class UesUmotionService {
  private core = new UesUmotionCore()
  ...
  async compile(userId: string, input: { projectId: string; name: string }) {
    ...
    const artifact = this.artifacts.register(userId, {
      projectId: input.projectId, fileId: file.id, type: 'animation.ues-umotion', producer: 'ues.umotion',
